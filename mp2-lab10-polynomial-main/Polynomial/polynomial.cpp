...
{
  TPolynomial res;
  TMonom* temp_1 = static_cast<TMonom*>(root);

  if (root == nullptr && _v.root)
    throw -1;

  while (temp_1 != nullptr)
  {
    TMonom* temp_2 = static_cast<TMonom*>(_v.root);

    while (temp_2 != nullptr)
    {
      TMonom temp_3;
      temp_3 = (static_cast<TMonom&>(*temp_2)) * (static_cast<TMonom&>(*temp_1));
      res += temp_3;
